...
parser.add_option("-l","--lazypop",dest="POP_WHEN_CAN",action="store_false",default=True)
parser.add_option("-u","--unlex",dest="UNLEX",action="store_true",default=False)
parser.add_option("--features",dest="feature_extarctor",default="eager.zhang")
